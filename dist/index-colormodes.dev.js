...
(function () {
  ...
  var showActiveTheme = function showActiveTheme(theme) {
    ...
    var btnToActive = document.querySelector("[data-bs-theme-value=\"".concat(theme, "\"]")); //   const svgOfActiveBtn = btnToActive.querySelector('svg use').getAttribute('href')

    var spanActive = btnToActive.querySelector('span i').getAttribute('class');
    document.querySelectorAll('[data-bs-theme-value]').forEach(function (element) {
      element.classList.remove('active');
      element.setAttribute('aria-pressed', 'false');
    });
    btnToActive.classList.add('active');
    btnToActive.setAttribute('aria-pressed', 'true'); //   activeThemeIcon.setAttribute('href', svgOfActiveBtn)

    activeThemeIcon.setAttribute('class', spanActive);
